...
import ScrollTriggerIcons from "../components/scroll-trigger-icons"
    ...
    <main className="relative w-full min-h-screen overflow-hidden font-sans">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4">
        <div className="text-center max-w-sm sm:max-w-lg md:max-w-xl">
          <TypewriterText />
          <p className="text-sm sm:text-base md:text-lg text-[#0000008A] font-sans mb-10 sm:mb-12 md:mb-18">
            Your one-stop digital platform for 3D models and digital creations. Join our community of creators and
            collectors today.
          </p>
          <button className="px-4 sm:px-6 md:px-8 py-2 sm:py-2.5 md:py-3 text-sm sm:text-base bg-[#0284C7] text-white rounded-full font-medium transition-colors overflow-hidden relative shine-infinite font-sans">
